...
**기준 공개 릴리스:** v1.0-public<br>
**개발 상태:** v1.1 작업 중 — 아직 태그·릴리스 미발행<br>
**v1.1 수치·자동화 검증일:** 2026-08-22<br>
**데이터·수치 검증일:** 2026-08-15<br>
**공개 패키지 검증일:** 2026-08-19<br>
...
| 항목 | v1.0-public | v1.1 pre-release |
|---|---:|---:|
| 시뮬레이션 곡선 | 5개 | 5개 |
...
- v1.1 산출물과 코드가 확정된 뒤 릴리스 매니페스트·CI를 최종 검증
